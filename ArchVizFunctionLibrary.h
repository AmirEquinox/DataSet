...
public:
	...
	UFUNCTION(BlueprintCallable, Category = " UI typewriter handled null ref of levels")
	static void TransitionToLevelHandledNullRef(FName LevelName, bool bAbsolute);

private:
	static void TypewriterCallback(UTextBlock* TextBlock, const FString& Text, int32 Index, float TypeSpeed, USoundBase* TypeSound);
	static void ClearAllTypewriterTimers();
